...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { comment: @information.comment, name: @information.name, phoneNumber: @information.phoneNumber, picture: @information.picture }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { comment: @information.comment, name: @information.name, phoneNumber: @information.phoneNumber, picture: @information.picture }
    assert_redirected_to information_path(assigns(:information))
  end
